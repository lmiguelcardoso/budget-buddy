...
const translations = {
  en: {
    ...
    "settings.ai_key_desc": "Your OpenAI API key is encrypted at rest and never exposed.",
    "settings.ai_key_label": "OpenAI API Key",
    "settings.ai_key_placeholder": "sk-...",
    "settings.ai_key_saved": "Key saved",
    "settings.ai_key_remove": "Remove",
    "settings.ai_key_save": "Save key",
  ...
  "pt-BR": {
    ...
    "settings.ai_key_desc": "Sua chave OpenAI é encriptada em repouso e nunca exposta.",
    "settings.ai_key_label": "Chave de API OpenAI",
    "settings.ai_key_placeholder": "sk-...",
    "settings.ai_key_saved": "Chave salva",
    "settings.ai_key_remove": "Remover",
    "settings.ai_key_save": "Salvar chave",
