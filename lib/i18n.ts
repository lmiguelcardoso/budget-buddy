...
const translations = {
  en: {
    ...
    "settings.ai_key": "AI Assistant",
    "settings.ai_key_desc": "Your API key is encrypted at rest and never exposed to the client.",
    "settings.ai_provider": "Provider",
    "settings.ai_key_label": "API Key",
    "settings.ai_key_placeholder": "Paste your API key…",
    "settings.ai_key_saved": "Key saved",
    "settings.ai_key_remove": "Remove",
    "settings.ai_key_save": "Save",
    "settings.ai_key_saving": "Saving…",
    "settings.ai_key_removing": "Removing…",
  ...
  "pt-BR": {
    ...
    "settings.ai_key": "Assistente de IA",
    "settings.ai_key_desc": "Sua chave de API é encriptada em repouso e nunca exposta ao cliente.",
    "settings.ai_provider": "Provedor",
    "settings.ai_key_label": "Chave de API",
    "settings.ai_key_placeholder": "Cole sua chave de API…",
    "settings.ai_key_saved": "Chave salva",
    "settings.ai_key_remove": "Remover",
    "settings.ai_key_save": "Salvar",
    "settings.ai_key_saving": "Salvando…",
    "settings.ai_key_removing": "Removendo…",
